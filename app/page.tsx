...
export default function ErsnobleMasterBuild() {
  ...
  return (
    <main ref={containerRef} className="bg-[#020202] text-white selection:bg-[#008BFF] font-sans antialiased overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 opacity-40 hidden md:block"
        style={{ background: `radial-gradient(circle 600px at ${mousePos.x}px ${mousePos.y}px, rgba(0, 139, 255, 0.15), transparent 80%)` }}
      />
      <div className="fixed inset-0 pointer-events-none z-0 opacity-20 md:hidden bg-[radial-gradient(circle_at_50%_50%,rgba(0,139,255,0.25),transparent_70%)]" />
      ...
      <nav className="fixed top-0 w-full z-[100] border-b border-white/[0.05] bg-black/80 backdrop-blur-2xl transition-all duration-500">
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-24 h-20 md:h-24 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:gap-8 z-[110]">
            ...
            <div className="hidden xs:flex items-center gap-2 px-3 py-1 border border-white/20 rounded-full bg-[#008BFF]/5">
          ...
          <div className="hidden lg:flex items-center gap-12 xl:gap-16">
            {[
              ...
              <Link key={item.name} href={item.href} className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 hover:text-white transition-colors hover:drop-shadow-[0_0_5px_#fff]">
                {item.name}
              </Link>
            ))}
          </div>
          ...
          <div className="flex items-center gap-4 z-[110]">
            ...
            >
              {isMenuOpen ? <X size={20} /> : <span className="text-[9px] font-black uppercase tracking-widest text-white/60 border border-white/10 px-3 py-2 rounded bg-white/5">Menu</span>}
            </button>
            ...
            >
              <span className="hidden sm:inline">Initialize Mandate</span>
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 pt-32 pb-20">
        <div className="max-w-[1800px] mx-auto w-full grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
          <div className="relative z-10">
            ...
            <motion.p {...fadeInUp} className="max-w-xl text-white/70 font-medium leading-relaxed mb-12 md:mb-16 border-l-2 border-[#008BFF] pl-6 md:pl-10 uppercase tracking-widest text-[11px] md:text-[13px]">
            ...
            <motion.div {...fadeInUp}>
              <Link href="/contact" className="group relative inline-flex items-center gap-8 bg-white text-black px-8 md:px-12 py-5 md:py-6 hover:bg-[#008BFF] hover:text-white transition-all duration-500 w-full sm:w-auto justify-between shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-[#008BFF] to-[#00D1FF] rounded-xl blur-xl lg:blur-3xl opacity-20 group-hover:opacity-50 transition duration-1000 animate-pulse" />
            <div className="bg-[#0A0A0A] border border-white/10 rounded-xl overflow-hidden relative z-10 shadow-2xl">
              <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4 bg-white/5 border-b border-white/10 font-mono text-[9px] md:text-[10px] text-white/50">
                <div className="flex gap-2">
                  <div className="w-2 h-2 rounded-full bg-red-500/50" />
                  <div className="w-2 h-2 rounded-full bg-[#008BFF] animate-pulse shadow-[0_0_5px_#008BFF]" />
                </div>
              ...
              <div className="p-6 md:p-10 space-y-6 md:space-y-8 font-mono">
                <div className="space-y-4">
                  ...
                  <pre className="text-[10px] md:text-xs text-white/60 leading-relaxed bg-black/60 p-4 md:p-6 rounded border border-white/5 relative overflow-hidden">
                    <code>{`const Ersnoble = {
  ...
  scaling: "Unlimited"
                    ...
                    <motion.div
                      ...
                      className="absolute left-0 w-full h-10 bg-gradient-to-b from-transparent via-[#008BFF]/10 to-transparent pointer-events-none"
                    />
                  </pre>
                </div>

                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  <div className="bg-white/5 p-4 md:p-6 border border-white/10 hover:border-[#008BFF]/40 transition-colors">
                    <div className="text-[8px] md:text-[9px] text-white/40 uppercase mb-1 md:mb-2">Security</div>
                    <div className="text-sm md:text-xl font-black text-[#008BFF] drop-shadow-[0_0_5px_#008BFF]">SVRN_1</div>
                  </div>
                  <div className="bg-white/5 p-4 md:p-6 border border-white/10 relative overflow-hidden">
                    <div className="text-[8px] md:text-[9px] text-white/40 uppercase mb-1 md:mb-2">Traffic</div>
                    <div className="text-sm md:text-xl font-black text-white">OPTIMAL</div>
                    <motion.div
                      animate={{ x: ['-100%', '100%'] }}
                      transition={{ duration: 3, repeat: Infinity, ease: "linear" }}
                      className="absolute bottom-0 left-0 h-[2px] w-full bg-[#008BFF] shadow-[0_0_15px_#008BFF]"
                    />
                  </div>
                </div>
              </div>
      ...
      <section id="ecosystem" className="py-24 md:py-40 bg-[#050505] border-y border-white/5 px-6 md:px-12 lg:px-24">
        <div className="max-w-[1800px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-8">
            ...
            <p className="max-w-md text-white/60 text-[10px] md:text-[11px] uppercase tracking-[0.4em] leading-loose">
              A unified system where professional branding and high-end engineering merge to create your most valuable business engine.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10 overflow-hidden rounded-sm">
            {[
              { icon: <PenTool />, title: "Identity Systems", desc: "Hard-coded design systems that establish immediate professional authority in your market." },
              { icon: <Activity />, title: "Conversion Logic", desc: "Behavioral engineering designed to turn visitors into committed, high-value clients." },
              { icon: <Smartphone />, title: "App Infrastructure", desc: "Custom mobile software built on secure, institutional-grade technical foundations." },
              { icon: <Globe />, title: "Web Architecture", desc: "Full-stack web deployment engineered to handle global traffic with zero latency." }
            ].map((s, i) => (
              <motion.div key={i} {...fadeInUp} className="bg-black p-10 md:p-16 group hover:bg-[#080808] transition-all relative">
                <div className="mb-8 md:mb-12 text-[#008BFF] group-hover:drop-shadow-[0_0_10px_#008BFF] transition-all duration-500">{s.icon}</div>
                <h4 className="text-lg md:text-xl font-black uppercase mb-4 md:mb-6 tracking-widest">{s.title}</h4>
                <p className="text-[10px] md:text-[11px] text-white/60 leading-relaxed uppercase tracking-widest group-hover:text-white transition-colors">{s.desc}</p>
                <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#008BFF] group-hover:w-full transition-all duration-500 shadow-[0_0_15px_#008BFF]" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 md:py-40 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto border border-white/10 bg-gradient-to-b from-white/[0.05] to-transparent p-8 md:p-24 relative overflow-hidden rounded-xl">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <div className="h-64 md:h-80 w-full mt-20 flex items-end gap-3 md:gap-4 px-2 md:px-4 border-l border-b border-white/10 relative">
              <div className="absolute -left-10 md:-left-16 top-0 h-full flex flex-col justify-between text-[8px] md:text-[9px] font-mono text-white/40 uppercase tracking-widest">
                <span>Scale</span><span>Launch</span><span>Audit</span>
              </div>
              <div className="flex-1 bg-white/5 h-[35%] relative group border-t border-white/5">
                <div className="absolute -top-12 left-0 text-[8px] md:text-[10px] font-mono opacity-40 uppercase tracking-tighter leading-tight">Typical Agency <br /> (6 Months+)</div>
              </div>
              <motion.div
                initial={{ height: 0 }}
                whileInView={{ height: '90%' }}
                transition={{ duration: 1.5, ease: "circOut" }}
                className="flex-1 bg-gradient-to-t from-[#008BFF] to-[#00D1FF] relative shadow-[0_0_50px_rgba(0,139,255,0.4)]"
              >
      ...
      <section id="works" className="py-24 md:py-40 px-6 md:px-12 lg:px-24 bg-[#020202]">
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
            {[
              { id: "ersnoble-ecosystem", title: "Ersnoble Digital Sovereignty", category: "Fullstack Build // Institutional", year: "2026", img: "/Ersnoble_Media.png" },
              ...
              <Link key={work.id} href={`/works/${work.id}`} className="group cursor-pointer block">
                <motion.div {...fadeInUp}>
                  <div className="relative aspect-[16/11] w-full overflow-hidden border border-white/10 bg-white/5 rounded-sm">
                    ...
                    <div className="absolute inset-0 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none bg-gradient-to-b from-[#008BFF]/10 via-transparent to-[#008BFF]/10" />
                    <div className="absolute bottom-6 right-6 z-30 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                      <div className="bg-[#008BFF] text-white p-3 rounded-full shadow-[0_0_30px_rgba(0,139,255,0.8)]">
                        <ArrowUpRight size={18} />
                      </div>
                    </div>
                  </div>
                  <div className="mt-8 flex justify-between items-end border-l-2 border-white/10 pl-6 group-hover:border-[#008BFF] transition-all duration-500">
                    <div>
                      <h5 className="text-xl md:text-2xl font-black uppercase tracking-tight mb-2 group-hover:text-[#008BFF] transition-colors">{work.title}</h5>
                      <p className="text-[9px] md:text-[10px] text-white/50 uppercase tracking-[0.4em]">{work.category}</p>
                    </div>
                    <div className="text-right">
                      <span className="text-[9px] font-mono text-white/40 block mb-1">RELEASE_VER</span>
                      <span className="text-[10px] md:text-[11px] font-mono text-[#008BFF] font-black">{work.year}</span>
                    </div>
                  </div>
                </motion.div>
              </Link>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute left-[23px] top-0 bottom-0 w-px bg-white/10 hidden md:block">
              <motion.div style={{ scaleY: scaleLine, originY: 0 }} className="w-full h-full bg-[#008BFF] shadow-[0_0_25px_#008BFF]" />
            </div>
            <div className="space-y-20 md:space-y-40">
              {[
                ...
                <motion.div key={i} {...fadeInUp} className="relative flex flex-col md:flex-row gap-8 md:gap-16 group">
                  <div className="relative z-10 h-12 w-12 rounded-full bg-black border border-white/20 flex items-center justify-center group-hover:border-[#008BFF] group-hover:shadow-[0_0_15px_#008BFF] transition-all flex-shrink-0">
                    <span className="text-[10px] font-black group-hover:text-[#008BFF] transition-colors">{item.step}</span>
                  </div>
                  <div className="flex-1 bg-white/[0.03] border border-white/5 p-8 md:p-12 group-hover:border-[#008BFF]/30 group-hover:bg-[#008BFF]/5 transition-all rounded-sm">
                    <div className="flex items-center gap-6 mb-4 md:mb-6">
                      <div className="text-white/40 group-hover:text-[#008BFF] transition-colors group-hover:scale-110 duration-500">{item.icon}</div>
                    ...
                    <p className="text-white/60 text-[12px] md:text-lg leading-relaxed uppercase tracking-[0.15em] md:tracking-[0.2em] group-hover:text-white transition-colors">{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      {/* 8. CTA SECTION */}
      <section className="py-32 md:py-64 px-6 md:px-12 text-center bg-white text-black relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-[#008BFF] shadow-[0_5px_15px_rgba(0,139,255,0.4)]" />
        <motion.h2 {...fadeInUp} className="text-5xl md:text-[140px] font-black uppercase tracking-tighter leading-tight md:leading-none mb-16 relative z-10">
          Execute <br />
          <span className="font-light italic lowercase text-black/40">the</span> Vision.
        </motion.h2>
        <Link href="/contact" className="group flex flex-col items-center gap-6 relative z-10">
          <div className="flex items-center gap-6 md:gap-12 border-b-4 md:border-b-8 border-black pb-4 group-hover:gap-16 transition-all duration-700">
            <span className="text-xl md:text-7xl font-black uppercase tracking-tighter">Initialize Mandate</span>
            <ArrowRight className="w-8 h-8 md:w-16 md:h-16 text-[#008BFF] group-hover:translate-x-4 transition-transform" />
          </div>
          <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] opacity-60">Engineering High-Stake Assets // 2026 Engagement</span>
        </Link>
      </section>
